...
export function TokenOverview({ tokenData, isLoading }: TokenOverviewProps) {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
      ...
      {/* Market Cap Card */}
      <Card className="crypto-card crypto-hover p-6 border bg-gradient-to-br from-blue-600 via-cyan-600 to-blue-700 border-blue-500 hover:from-blue-500 hover:via-cyan-500 hover:to-blue-600 transition-all duration-300 shadow-lg shadow-blue-500/20">
        <div className="flex items-center justify-between mb-4">
      ...
      {/* Volume Card */}
      <Card className="crypto-card crypto-hover p-6 border bg-gradient-to-br from-amber-600 via-orange-600 to-amber-700 border-amber-500 hover:from-amber-500 hover:via-orange-500 hover:to-amber-600 transition-all duration-300 shadow-lg shadow-amber-500/20">
        <div className="flex items-center justify-between mb-4">
      ...
      {/* Liquidity Card */}
      <Card className="crypto-card crypto-hover p-6 border bg-gradient-to-br from-purple-600 via-pink-600 to-purple-700 border-purple-500 hover:from-purple-500 hover:via-pink-500 hover:to-purple-600 transition-all duration-300 shadow-lg shadow-purple-500/20">
        <div className="flex items-center justify-between mb-4">
